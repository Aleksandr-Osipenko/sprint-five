...
func (w Walking) Calories() float64 {
	...
	return (CaloriesWeightMultiplier*w.Weight + ((math.Pow((meanSpeedInMSec), 2)/HeightInM)*CaloriesSpeedHeightMultiplier*w.Weight)*float64(w.Duration.Hours())*MinInHours)
}
